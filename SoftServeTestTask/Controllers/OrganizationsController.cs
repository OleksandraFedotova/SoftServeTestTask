...
namespace SoftServeTestTask.Controllers
{
    ...
    public class OrganizationsController : Controller
    {
        ...
        [AllowAnonymous]
        [HttpGet(Name = "Get")]
        public JsonResult GetOrganizationTree(int OrganizationId)
        {
            var tree = _context.Organizations.
                Where(org => org.OrganizationId == OrganizationId).
                Include(o => o.Countries).
                ThenInclude(c => c.BusinessList).
                ThenInclude(b => b.Families).
                ThenInclude(f => f.Offerings).
                ThenInclude(of => of.Departments).
                ToList();
        ...
        public async Task<IActionResult> Create([Bind("OrganizationId,Name,Code,UserId")] Organization organization)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrganizationId,Name,Code,UserId")] Organization organization)
        {
